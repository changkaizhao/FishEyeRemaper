...
using namespace std;
using namespace cv;
const string rootPath = "/Development/OPENGL/panomaric Stitching/";
const string  filename = rootPath+"ip6pic/IMG_2513.JPG";//spherical0.jpg";
...
int main(int argc, const char * argv[])
{
    ...
    //FishEyeSphereRemaper fer(cmossize,pixelsize,fishimg.rows,fitfunc2,180,1591.7,1223.93);
